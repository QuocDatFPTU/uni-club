...
const ClubEditForm = ({ item, onCallback, isEditModal, setIsEditModal }) => {
	...
	const initalValue = {
		...
		ClubName: item ? item["club-name"] : "",
		ShortName: item ? item["short-name"] : "",
		Description: item ? item.description : "",
		ShortDescription: item ? item["short-description"] : "",
		AvatarUrl: item ? item["avart-url"] : "",
		EstablishedDate: item ? item["established-date"] : "",
